...
"""
Set: SZ function
comment: можно добавить неучитываемы порядки и точную функцию
"""
...
def SZfunction(T0, theta, beta, Tau, x, rel_corrs=True):
    ...
    Y4 = (- 135 / 32 + 30375 / 128 * X - 62391 / 10 * X ** 2 + 614727 / 40 * X ** 3 
            ...
            + S ** 2 * (- 62391 / 20 + 614727 / 20 * X - 1368279 / 20 * X ** 2 + 4624139 / 80 * X ** 3 - 157396 / 7 * X ** 4 + 30064 / 7 * X ** 5
