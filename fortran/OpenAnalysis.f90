    ...
    do i=1, num_prior
        ...
        if (mode == 1) then 
            ...
            if ((iuv>1) .and. (inH>1)) then 
                chi2 = lnL_H2(iuv-1,inH) + (loguv-loguv_LH2(iuv))/(loguv_LH2(iuv-1)-loguv_LH2(iuv))*(lnL_H2(iuv,inH)-lnL_H2(iuv-1,inH))
                chi1 = lnL_H2(iuv-1,inH-1) + (loguv-loguv_LH2(iuv))/(loguv_LH2(iuv-1)-loguv_LH2(iuv))*(lnL_H2(iuv,inH-1)-lnL_H2(iuv-1,inH-1))
